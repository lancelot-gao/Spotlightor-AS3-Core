 ...
 * version log:
 *
 *	09.01.15		1.5		GaoMing			+ Hide on DOUBLE_CLICK 
...
package com.spotlightor.utils
{
	...
	{	
		...
		private function onAddedToStage( e : Event ) : void
		{
			...
			trace("You can hide stats by double click.");
		...
		{
			(this.mouseY > this.height * .35) ? stage.frameRate-=5 : stage.frameRate+=5;
			fpsText.text = "FPS: " + fps + " / " + stage.frameRate;
		}	
